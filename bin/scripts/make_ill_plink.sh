...
# Replace spaces with underscores in columns 1 and 2 of Geno.all.txt2
awk -F $'\t' 'BEGIN { OFS="\t" } {gsub(/ /, "_", $1); gsub(/ /, "_", $2); print}' Geno.all.txt2 > Geno.all.txt2.tmp
mv Geno.all.txt2.tmp Geno.all.txt2
